...
def clean_scraped_data(clean):
  '''
  clean scraped data from greatschools.org website

  Parameters
  ----------
  clean: mongodb collection of json dictionaries

  Results
  -------
  a csv file ready for exploratory data analysis
  '''
